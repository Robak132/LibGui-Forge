...
import io.github.robak132.libgui_forgified.MouseInputHandler;
import io.github.robak132.libgui_forgified.SyncedGuiDescription;
import io.github.robak132.libgui_forgified.mixin.ScreenAccessor;
...
public class CottonInventoryScreen<T extends SyncedGuiDescription> extends AbstractContainerScreen<T> implements
    ...
    protected void reposition(int screenWidth, int screenHeight) {
        ...
        titleLabelX = description.getTitlePos().y();

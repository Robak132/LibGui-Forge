...
public final class NarrationMessages {
    ...
    public static final Component SCROLL_BAR_TITLE = Component.translatable(
            "widget.libgui_forge.scroll_bar.narration.title");
    ...
    public static final Component TOGGLE_BUTTON_OFF = Component.translatable(
            "widget.libgui_forge.toggle_button.narration.off");
    public static final Component TOGGLE_BUTTON_ON = Component.translatable(
            "widget.libgui_forge.toggle_button.narration.on");

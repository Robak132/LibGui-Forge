...
import io.github.robak132.libgui_forgified.client.CottonHud;
...
import io.github.robak132.libgui_forgified.widget.data.ObservableProperty;
import io.github.robak132.libgui_forgified.widget.focus.FocusModel;
...
public class WWidget {
     ...
     * focus if it is focused. Overriding implementations might want to do this as well.
     *
     * @since 3.0.0
     */
    ...
    /**
     * Returns whether the user is hovering over this widget. This is equivalent to calling
     * <code>{@link #hoveredProperty()}.get()</code>.
     *
    ...
    /**
     * Sets the {@link #hoveredProperty() hovered} property. This is equivalent to calling
     * <code>{@link #hoveredProperty()}.set(<i>hovered</i>)</code>.
     *

...
public class WTextField extends WWidget {
    ...
    private void checkScrollOffset() {
        int rightMostScrollOffset =
                text.length() - font.plainSubstrByWidth(text, width - TEXT_PADDING_X * 2, true).length();
    ...
    protected void renderTextField(GuiGraphics context, int x, int y) {
        ...
        checkScrollOffset();
        String visibleText = font.plainSubstrByWidth(this.text.substring(this.scrollOffset),

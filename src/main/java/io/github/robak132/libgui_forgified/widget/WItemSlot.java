...
import io.github.robak132.libgui_forgified.ValidatedSlot;
...
import io.github.robak132.libgui_forgified.widget.focus.Focus;
...
public class WItemSlot extends WWidget {
     ...
     * @since 6.2.0
     */
    public static final ResourceLocation SLOT_TEXTURE = ResourceLocation.tryBuild(LibGui.MOD_ID,

...
/**
 * A {@link SyncedGuiDescription} for an {@linkplain ItemStack item stack} in an {@linkplain Container inventory}.
 *
 * <p>The owning item is represented with a {@link SlotAccess}, which can be
 * an item in an entity's inventory or a block's container, or any other reference to an item stack.
 *
